...
#
# Fork: raised to 400K (upstream default 15000) for the medical-research use case —
# PubMed/UpToDate articles are typically 20K-80K chars and need to be returned whole
# for thorough clinical analysis, not truncated to a 15K head+tail window. The
# truncate-store-read_file path still activates for genuinely huge pages (>400K).
