...
class LineAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config, **kwargs):
        ...
        # Fork: reply only when @-mentioned (groups only, DMs always respond)
        self.reply_only_mention = _truthy_env("LINE_REPLY_ONLY_MENTION", bool(extra.get("reply_only_mention", False)))
    ...
    async def _handle_message_event(self, event: Dict[str, Any]) -> None:
        ...
        # Fork — Mention-only mode: in groups, skip if bot not @-mentioned.
