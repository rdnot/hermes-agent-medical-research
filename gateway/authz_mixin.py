...
_GROUP_CHAT_ENV = {Platform.TELEGRAM: "TELEGRAM_GROUP_ALLOWED_CHATS", Platform.QQBOT: "QQ_GROUP_ALLOWED_USERS", Platform.LINE: "LINE_ALLOWED_GROUPS"}  # LINE: fork-only (static Platform.LINE member)
_ALLOW_BOTS_ENV = {
